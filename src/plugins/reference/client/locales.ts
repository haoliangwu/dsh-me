...
export const zh = {
  ...
  'description': '描述',
  'menuVisible': '@ 菜单',
  'menuVisibleHint': '关闭 = 该引用不再出现在 @ 提及菜单；系统提示广告不受影响。',
  'save': '保存',
  'cancel': '取消',
  'edit': '编辑',
  'delete': '删除',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'menuVisible': '@ menu',
  'menuVisibleHint': 'Turn off to exclude this reference from the @ mention menu; system-prompt advertisement is unaffected.',
  'save': 'Save',
  'cancel': 'Cancel',
  'edit': 'Edit',
  'delete': 'Delete',
